package com.github.dapeng.hello;
        ...
        **/
        public class HelloServiceCodec {
            ...
            public static class sayHello<I extends com.github.dapeng.hello.service.HelloService> extends SoaFunctionDefinition.Sync<I, sayHello_args, sayHello_result>
            {
              ...
              public sayHello_result apply(I iface, sayHello_args sayHello_args) throws SoaException
              {
                ...
                result.setSuccess(iface.sayHello(sayHello_args.getHello()));
            ...
            public static class sayHello2<I extends com.github.dapeng.hello.service.HelloService> extends SoaFunctionDefinition.Sync<I, sayHello2_args, sayHello2_result>
            {
              public sayHello2()
              {
        ...
        public static class echo<I extends com.github.dapeng.hello.service.HelloService> extends SoaFunctionDefinition.Sync<I, echo_args, echo_result> {
          public echo() {
