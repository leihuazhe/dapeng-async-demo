        ...
        **/
        public class HelloServiceSuperCodec {
            ...
            public static class sayHello_result {
                  ...
                  private com.github.dapeng.hello.domain.HelloResponse success;
                  public com.github.dapeng.hello.domain.HelloResponse getSuccess(){
                  return success;
                }

                  public void setSuccess(com.github.dapeng.hello.domain.HelloResponse success){
            ...
            public sayHello_result read(TProtocol iprot) throws TException{
              ...
              while(true){
                ...
                switch(schemeField.id){
                  case 0:  //SUCCESS
                  if(schemeField.type == com.github.dapeng.org.apache.thrift.protocol.TType.STRUCT){
                    com.github.dapeng.hello.domain.HelloResponse elem0 = new com.github.dapeng.hello.domain.HelloResponse();
        elem0=new com.github.dapeng.hello.domain.serializer.HelloResponseSerializer().read(iprot);
      ...
      oprot.writeStructBegin(new com.github.dapeng.org.apache.thrift.protocol.TStruct("sayHello_result"));
            ...
            com.github.dapeng.hello.domain.HelloResponse elem0 = bean.getSuccess();
             new com.github.dapeng.hello.domain.serializer.HelloResponseSerializer().write(elem0, oprot);
      ...
      public void validate(sayHello_result bean) throws TException{
              ...
              throw new SoaException(SoaCode.StructFieldNull, "success字段不允许为空");
                ...
                if(bean.getSuccess() != null)
                new com.github.dapeng.hello.domain.serializer.HelloResponseSerializer().validate(bean.getSuccess());
