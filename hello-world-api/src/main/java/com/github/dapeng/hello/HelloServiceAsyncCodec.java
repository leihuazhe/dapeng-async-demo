package com.github.dapeng.hello;
        ...
        **/
        public class HelloServiceAsyncCodec {
            ...
            public static class sayHello<I extends com.github.dapeng.hello.service.HelloServiceAsync> extends SoaFunctionDefinition.Async<I, sayHello_args, sayHello_result>
            {
              public sayHello()
              {
              ...
              {
                CompletableFuture<com.github.dapeng.hello.domain.HelloResponse> result = (CompletableFuture<com.github.dapeng.hello.domain.HelloResponse>) iface.sayHello(sayHello_args.getHello());
                return result.thenApply(( com.github.dapeng.hello.domain.HelloResponse i) -> {
            ...
            public static class sayHello2<I extends com.github.dapeng.hello.service.HelloServiceAsync> extends SoaFunctionDefinition.Async<I, sayHello2_args, sayHello2_result>
            {
              public sayHello2()
              {
              ...
              {
                CompletableFuture<com.github.dapeng.hello.domain.HelloResponse> result = (CompletableFuture<com.github.dapeng.hello.domain.HelloResponse>) iface.sayHello2(sayHello2_args.getHello());
                return result.thenApply(( com.github.dapeng.hello.domain.HelloResponse i) -> {
        ...
        public static class getServiceMetadata<I extends com.github.dapeng.hello.service.HelloServiceAsync> extends SoaFunctionDefinition.Async<I, getServiceMetadata_args, getServiceMetadata_result> {
        ...
        public static class echo<I extends com.github.dapeng.hello.service.HelloServiceAsync> extends SoaFunctionDefinition.Async<I, echo_args, echo_result> {
          public echo() {
        ...
        public static class Processor<I extends com.github.dapeng.hello.service.HelloServiceAsync> extends SoaServiceDefinition<com.github.dapeng.hello.service.HelloServiceAsync>
        {

          public Processor(com.github.dapeng.hello.service.HelloServiceAsync iface, Class<com.github.dapeng.hello.service.HelloServiceAsync> ifaceClass)
          {
            super(iface, ifaceClass, buildMap(new java.util.HashMap<>()));
          }

          @SuppressWarnings("unchecked")
          private static <I extends com.github.dapeng.hello.service.HelloServiceAsync> java.util.Map<String, SoaFunctionDefinition<I, ?, ?>> buildMap(java.util.Map<String, SoaFunctionDefinition<I, ?, ?>> processMap)
          {
