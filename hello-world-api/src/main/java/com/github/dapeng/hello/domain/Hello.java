 ...
 * DO NOT EDIT UNLESS YOU ARE SURE THAT YOU KNOW WHAT YOU ARE DOING
        ...
        **/
        ...
        public static byte[] getBytesFromBean(Hello bean) throws TException {
          ...
          new com.github.dapeng.hello.domain.serializer.HelloSerializer().write(bean, protocol);
          transport.flush();
        ...
        public static Hello getBeanFromBytes(byte[] bytes) throws TException {
          ...
          TCompactProtocol protocol = new TCompactProtocol(transport);
          return new com.github.dapeng.hello.domain.serializer.HelloSerializer().read(protocol);
        }
